    ...
    if video_url:
        ...
        if original_frame is not None:
            ...
            if y_lowest_yellow is None:
                ...
                previous_water_level = water_level  # Update previous level
            ...
            return render_template('index.html', error="Failed to capture frame from video.")
    else:
        return render_template('index.html', error="Failed to retrieve video metadata.")
